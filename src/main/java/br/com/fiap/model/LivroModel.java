...
public class LivroModel {
	...
	@NotEmpty(message="É necessário cadastrar um sku.")
	private int sku;
	
	@NotEmpty(message="Titulo do livro n�o pode estar vazio.")
	private String titulo;
	
	@NotEmpty(message="Editora do livro n�o pode estar vazia.")
